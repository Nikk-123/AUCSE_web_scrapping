...
URL = "https://www.aucse.in/people/student/btech/cse-batch-2022-2026"  # Replace with the actual URL
headers = {
...
sheet.append(["Roll Number", "Name", "Image URL", "Department"])

# Extracting data from HTML
sections = soup.find_all("section", {"class": ["yaqOZd cJgDec tpmmCb", "yaqOZd"]})
